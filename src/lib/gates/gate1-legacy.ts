// ============================================================
// GATE 1 LEGACY — PRODUCT INTELLIGENCE (ARCHIVED 2026-04-07)
//
// This is the original Gate 1 = Product Intelligence pipeline.
// It was replaced by the new Gate 1 = Avatar Excavation pipeline,
// which starts from a human-provided Core Avatar and runs real
// multi-source scraping + sub-avatar generation.
//
// This file is kept so the old product-intel sub-agents
// (product-scraper, market-researcher, competitor-analyst,
// alt-solutions, buyer-psychologist) can be re-activated later
// or ported into a different gate if needed.
//
// NOT registered in registry.ts. Not imported anywhere.
// ============================================================

import { GateConfigDef } from './types';

const gate1Legacy: GateConfigDef = {
  id: 'gate1',
